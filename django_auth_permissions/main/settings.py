...
REST_FRAMEWORK = {
    ...
    #     #? BasicAuthentication: It only checks if the user has a username and password and performs Authentication.
    #     #? http://127.0.0.1:8000/api/student/ : We can still access the endpoints, in this part, permissions come into play to enable authentication. We will define permissions stupent_api views.py.
    # ]
     'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',
        #? TokenAuthentication: To use it, we need to add 'rest_framework.authtoken' to the INSTALLED_APPS section, it creates a Token table in the database for us. TokenAuth. It helps us to create tokens manually in the admin panel.
        #? http://127.0.0.1:8000/api/student/ : We can still access the endpoints, in this part, permissions come into play to enable authentication. We will define permissions stupent_api views.py.
    ]
